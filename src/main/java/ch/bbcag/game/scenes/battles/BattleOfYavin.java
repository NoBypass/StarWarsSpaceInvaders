...
public class BattleOfYavin extends Battle {
    private Player player = new Player(space, new Point(400, 400));

    public BattleOfYavin(Navigator navigator) {
        super(new Group());
    ...
    protected void update(double deltaInSec) {
        ...
        currentWave++;
        Object[][] enemySchema = {
                {EnemyType.TIE_FIGHTER, 1},
                {EnemyType.TIE_DEFENDER, 1},
                {EnemyType.STAR_DESTROYER, 1},
        };
